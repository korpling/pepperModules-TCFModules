...
public class TCFMapperImportTest {
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing the primary
	 * text is converted to salt correctly by {@link TCFMapperImport}
	 * 
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing the tokens is
	 * converted to salt correctly by {@link TCFMapperImport}
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	public void testTokens() throws XMLStreamException, FileNotFoundException {
		...
		tmpOut.getParentFile().mkdirs();// necessary? – is this test meant to be
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing pos-tagged
	 * tokens is converted to salt correctly by {@link TCFMapperImport}. In this
	 * test case a single annotation over a sequence of tokens is used.
	 * {@link TCFMapperImport} is supposed to build a {@link SSpan} over a token
	 * sequence that is POS annotated while single tokens annotations are
	 * directly stored at the {@link SToken} object as {@link SPOSAnnotation}.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	 ...
	 * tokens is converted to salt correctly by {@link TCFMapperImport}. In this
	 * test case a single annotation over a sequence of tokens is used.
	 * {@link TCFMapperImport} is supposed to build a {@link SSpan} both over a
	 * token sequence and a single token. The {@link SPOSAnnotation} has to be
	 * added to the {@link SSpan} object.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing a sentence and
	 * tokens is converted to salt correctly by {@link TCFMapperImport}
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing lemmas and
	 * tokens is converted to salt correctly by {@link TCFMapperImport}. The
	 * mapper is supposed to map annotations as {@link SLemmaAnnotation} objects
	 * directly on the {@link SToken} objects for single token annotations and
	 * on an {@link SSpan} object in case of multiple token annotation.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	 ...
	 * tokens is converted to salt correctly by {@link TCFMapperImport}. The
	 * mapper is supposed to map annotations as {@link SLemmaAnnotation} objects
	 * directly as annotations on {@link SSpan} objects for single token
	 * annotations and in case of multiple token annotation.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	 ...
	 * annotations (no multi-governing) is converted to salt correctly by
	 * {@link TCFMapperImport}
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	public void testDepparsingNoMultigovs() throws XMLStreamException, FileNotFoundException {
		 ...
		 * -- compare template salt model to imported salt model --
		 * 
		 * in this test we try to be independent of the order of the elements in
		 * their lists, which makes the test on the one hand more general, on
		 * the other hand more complicated
		 */
		SDocumentGraph fixGraph = getFixture().getDocument().getDocumentGraph();
		SDocumentGraph docGraph = doc.getDocumentGraph();
		 ...
		 * check dependencies
		 * 
		 * we have to do it in the linear order of the tokens, because the
		 * doubling of both tokens (String) AND dependencies (String) is
		 * possible
		 */
		SToken fixTok = null;
	...
	public void testConstituentParsing() throws XMLStreamException, FileNotFoundException {
		...
		xmlWriter.writeStartElement(TCFDictionary.NS_TC, TCFDictionary.TAG_TC_CONSTITUENT, TCFDictionary.NS_VALUE_TC);// root
																														// node
		...
		SampleGenerator.createTokens(doc);
		/*
		 * TODO create Version 2 of both the following methods --> Root node
		 * necessary to include punctuation
		 */
	...
	public void testConstituentParsingShrinked() throws FileNotFoundException, XMLStreamException {
		...
		xmlWriter.writeAttribute(TCFDictionary.ATT_CAT, "NP");
		xmlWriter.writeAttribute(TCFDictionary.ATT_ID, "c6");
		xmlWriter.writeStartElement(TCFDictionary.NS_TC, TCFDictionary.TAG_TC_CONSTITUENT, TCFDictionary.NS_VALUE_TC);// "New
																														// York"
	 ...
	 * annotations is converted to salt correctly by {@link TCFMapperImport}.
	 * The Mapper is supposed to build a span for both morphology annotations on
	 * single and on multiple {@link SToken} objects.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	public void testMorphologyNotShrinked() throws XMLStreamException, FileNotFoundException {
		...
		xmlWriter.writeAttribute(TCFDictionary.ATT_TYPE, "stem");
		xmlWriter
				.writeCharacters("complicated");/*
												 * we do not consider the
												 * linguistic discussion on that
												 */
		xmlWriter.writeEndElement();
		xmlWriter.writeEndElement();
		xmlWriter.writeEndElement();
		...
		// in this last annotation (storage of segment.type) we use a namespace
		// to avoid ambiguities
		// with potential morphological properties used in
		// <analysis>...</analysis> (therefore namespace = TAG_TC_SEGMENT)
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "be");
		// the character sequence between <segment>...</segment> will be
		// represented in the same namespace and with key=TAG(=namespace)
		...
		sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT, TCFDictionary.ATT_TYPE, "stem");
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "example");
		docMorphLayer.addNode(sSpan);
		...
		sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT, TCFDictionary.ATT_TYPE, "stem");
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "complicated");
		docMorphLayer.addNode(sSpan);
		...
		sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT, TCFDictionary.ATT_TYPE, "stem");
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "than");
		docMorphLayer.addNode(sSpan);
		...
		sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT, TCFDictionary.ATT_TYPE, "stem");
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "it");
		docMorphLayer.addNode(sSpan);
		...
		sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT, TCFDictionary.ATT_TYPE, "stem");
		// sSpan.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "appear");
		docMorphLayer.addNode(sSpan);
	 ...
	 * This method tests if a valid TCF-XML-structure containing morphology
	 * annotations is converted to salt correctly by {@link TCFMapperImport}.
	 * The Mapper is supposed to build a span only for morphology annotations on
	 * multiple {@link SToken} objects. In case of single tokens the
	 * {@link SAnnotation} is build directly on the {@link SToken} object.
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	public void testMorphologyShrinked() throws XMLStreamException, FileNotFoundException {
		...
		// with potential morphological properties used in
		// <analysis>...</analysis> (therefore namespace = TAG_TC_SEGMENT)
		// sNode.createAnnotation(TCFDictionary.TAG_TC_SEGMENT,
		// TCFDictionary.TAG_TC_SEGMENT, "be");//
		// the character sequence between <segment>...</segment> will be
		// represented in the same namespace and with key=TAG(=namespace)
		// I'm not sure I like that
	...
	public void testNamedEntitiesShrinked() throws XMLStreamException, FileNotFoundException {
		...
		// add tokens to NE-layer and annotate them as named entities; add tag
		// set (type) information to layer
	...
	public void testReferencesShrinked() throws XMLStreamException, FileNotFoundException {
		...
		xmlWriter.writeStartElement(TCFDictionary.NS_TC, TCFDictionary.TAG_TC_ENTITY, TCFDictionary.NS_VALUE_TC);// entity
																													// "New
																													// York"
		...
		xmlWriter.writeAttribute(TCFDictionary.ATT_TOKENIDS, "t3 t4");
		xmlWriter.writeAttribute(TCFDictionary.ATT_MINTOKIDS, "t3 t4");// no
																		// clearly
																		// identified
																		// head
		...
		xmlWriter.writeAttribute(TCFDictionary.ATT_MINTOKIDS, "t11");// we
																		// choose
																		// the
																		// nominal
																		// head,
	...
	public void testReferencesShrinked2() throws XMLStreamException, FileNotFoundException {
		...
		xmlWriter.writeEndElement();// End of NY-1
		xmlWriter.writeEndElement();// End of entity "New York"
		xmlWriter.writeStartElement(TCFDictionary.NS_TC, TCFDictionary.TAG_TC_ENTITY, TCFDictionary.NS_VALUE_TC);// start
																													// pseudo
																													// entity
	...
	/**
	 * This method tests if a valid TCF-XML-structure containing
	 * lexical-semantic annotations is converted to salt correctly
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
	...
	public void testLexicalSemanticAnnotationsShrinked() throws XMLStreamException, FileNotFoundException {
		...
		/*
		 * since the parser first hits synonymy and token 0 and 4 (1 and 5) are
		 * not contained, we must add them in order of their appearance
		 */
	...
	public void testWordSplittingsShrinked() throws FileNotFoundException, XMLStreamException {
		...
		// example:
		docTokens.get(1).createAnnotation(TCFMapperImport.LAYER_SPLITTINGS, TCFDictionary.TAG_TC_SPLIT, "1"); // I
																												// know
																												// ...
	...
	public void testWordSplittingsNotShrinked() throws FileNotFoundException, XMLStreamException {
		...
		// example:
		SSpan sSpan = docGraph.createSpan(docTokens.get(1));
		sSpan.createAnnotation(TCFMapperImport.LAYER_SPLITTINGS, TCFDictionary.TAG_TC_SPLIT, "1"); // I
																									// know
																									// ...
		...
		// complicated:
		sSpan = docGraph.createSpan(docTokens.get(4));
		sSpan.createAnnotation(TCFMapperImport.LAYER_SPLITTINGS, TCFDictionary.TAG_TC_SPLIT, "3 6 8"); // I
																										// know
																										// ...
		docSplitLayer.addNode(sSpan);
		...
		sSpan.createAnnotation(TCFMapperImport.LAYER_SPLITTINGS, TCFDictionary.TAG_TC_SPLIT, "2"); // I
																									// know
																									// ...
		docSplitLayer.addNode(sSpan);
	 ...
	 * connectives annotations is converted to salt correctly
	 * 
	 * @throws XMLStreamException
	 * @throws FileNotFoundException
	 */
